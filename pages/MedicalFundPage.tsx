...
const MedicalFundPage: React.FC = () => {
  return (
    <>
      <section className="relative bg-cover bg-center h-96" style={{ backgroundImage: "url('https://picsum.photos/seed/medical/1200/400')" }}>
        <div className="absolute inset-0 bg-black opacity-60"></div>
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center">
          <h1 className="text-5xl font-extrabold">Athletes Medical Fund</h1>
          <p className="mt-4 text-xl">Protecting and supporting our student-athletes</p>
        </div>
      </section>
